...
SYSTEM_GUARDRAIL_PROMPT = (
    ...
    "- Use consistent role assignments across surveillance provisions and workflow steps.\n"
    "- An OH Technician (OHT) may administer questionnaires, but interpretation requires "
    "an OH professional (OHN/OHP).\n"
    "- Use canonical terminology: audiometry, not colloquial 'hearing test'.\n"
